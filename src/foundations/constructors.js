...
console.log(
  'Invoking Address without the "new" keyword will pollute the global namespace',
);
...
console.log('\n');
console.log(
  'On other hand, "SafeAddress" will guarantee to always invoke "Address" using the "new" keyword',
);
...
console.log('\n');
console.log(
  'In a last example, "SafeAddressPattern" will always be safe to invoke, either with "new" or directly',
);
console.log('const safeAddressPattern1 = SafeAddressPattern("789 3rd ave");', {
  safeAddressPattern1,
});
console.log(
  'const safeAddressPattern2 = new SafeAddressPattern("789 3rd ave");',
